...
public class FtEscanteioHandler extends Handler<PreJogoContext, Jogo> {

    public FtEscanteioHandler() {
    }

    @Override
    public void analisar() throws HandlerException {
        Estatisticas.Escanteio.FTS
                .stream()
        ...
        // proxima estatistica
        getContexto().avancarParaProximaEstatisca(new HtEscanteioHandler());
    }
