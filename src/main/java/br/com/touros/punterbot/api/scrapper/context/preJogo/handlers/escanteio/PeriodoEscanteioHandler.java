...
import br.com.touros.punterbot.api.scrapper.context.preJogo.handlers.gol.AmbosMarcaramGolHandler;
...
public class PeriodoEscanteioHandler extends Handler<PreJogoContext, Jogo> {

    public PeriodoEscanteioHandler() {
    }

    @Override
    public void analisar() throws HandlerException {
        Estatisticas.Escanteio.PERIODOS
                .stream()
        ...
        // proxima estatistica
        getContexto().avancarParaProximaEstatisca(new AmbosMarcaramGolHandler());
    }
